export const FirstScreen = () => {
  return (
    <section className="relative">
      ...
      <div className="absolute bottom-[58px] lg:bottom-[102px] left-0 lg:left-1/2 lg:-translate-x-1/2 mx-[15px] lg:mx-0 lg:max-w-[1440px] xl:w-[80%] xxl:w-full">
        <h1 className="font-monument uppercase text-[32px] lg:text-[40px] leading-[1.1] mb-[15px] lg:mb-10 xl:text-[52px] xxl:text-[68px]">
